...
import { dataBeneficies, dataDelivered, dataFaqs, dataHowItWorks, dataPlataforms, dataTestimonials, dataTimer, news } from "./data/dataSections";
...
export default function Page() {
  const title = "A melhor Empresa de Copywrite de belo horizonte"
  ...
  return (
    ...
    <main>
      ...
      <HeroGeralSectionImage img={robotHero}   title={title} description={description} highlightBlue="Empresa" highlightPink="Copywrite" />
      <GreatOfferOne img={robotHero} title={title} description={description} data={info}/>
      <NewsRepportOne reverse={true} cover={robotHero} title="Veja o que midia diz sobre copywrite" description="descricao brece" data={news}/>
      <PlataformOne title="titulo sobre plataforma" description="descricao sobre as plataformas" data={dataPlataforms}/>
      <HowItWorksOne data={dataHowItWorks}/>
      <TriggerServiceOne description="descricao brese ttrabalhos com texto pesuasivos" title=" Faça seus clientes ficarem impressionadas " img={robotHero} link="#"/>
