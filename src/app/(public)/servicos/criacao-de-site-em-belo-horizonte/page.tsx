...
export default function Page() {
  const title = "A melhor Empresa de Desenvolvimento de Sites de belo horizonte"
  ...
  return (
    ...
    <main>
      ...
      <HeroGeralSectionImage img={robotHero}   title={title} description={description} highlightBlue="Desenvolvimento" highlightPink="Sites" />
      <GreatOfferOne img={robotHero} title={dataGreatOffer.title} description={dataGreatOffer.decription} data={dataGreatOffer.items}/>
      <NewsRepportOne reverse={true} cover={robotHero} title="Veja o que midia diz sobre o mercado online." description="descricao brece" data={news}/>
      <PlataformOne title="Quais tipos de sites nós desenvolvemos" description="descricao sobre as plataformas" data={dataPlataforms}/>
      <HowItWorksOne data={dataHowItWorks}/>
      <TriggerServiceOne description="Tenha uma vitrine virtual sempre online e mostra seu valor. Garanta que seus clientes encontre você na internet." title=" Seus clientes estão te proucurando online. " img={robotHero} link="#"/>
