...
import { VideoYoutube } from "@/components/VideoTumbnail";

export  const HeroSites = async() => {
  return (
    <section className="container grid lg:grid-cols-2 place-items-center py-10 md:py-40 gap-10 ">
    <Image loading="lazy" src={LogoBrain} alt="logo raciocine" className="absolute right-40 top-10 opacity-[6%] z-0 md:opacity-20"/>
